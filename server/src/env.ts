...
['OPENAI_API_KEY', 'ANTHROPIC_API_KEY', 'GEMINI_API_KEY', 'OPENROUTER_API_KEY', 'DATABASE_URL', 'JWT_SECRET', 'AI_PROVIDER', 'ADMIN_EMAIL', 'ADMIN_PASSWORD', 'ADMIN_NAME'].forEach(trimEnv);
